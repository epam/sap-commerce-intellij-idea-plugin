...
- 26 PR(s) by [Mykhailo Lytvyn](https://github.com/epam/sap-commerce-intellij-idea-plugin/pulls?q=milestone%3A2026.0.7+author%3Amlytvyn+is%3Apr)
...
- Ensure that the whole ImpEx statement (table) will be formatted despite the modified/selected range [#1815](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/1815)
