...
- Load VM Properties no longer from the Properties File. Use instead the wrapper.conf files from the Tomcat Folder [#1293](https://github.com/epam/sap-commerce-intellij-idea-plugin/issues/1293)
