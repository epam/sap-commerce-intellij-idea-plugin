...
- Migrate to [Light Services](https://plugins.jetbrains.com/docs/intellij/plugin-services.html#light-services) [#759](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/759)
