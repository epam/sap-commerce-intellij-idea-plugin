...
- Introduced Hybris-specific JPS implementation to exclude resources content from the compile output directories [#1598](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/1598)
