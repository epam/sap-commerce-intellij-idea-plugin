...
- IntelliLang pattern fix applied multiple times on each project re-openning during the same session [#884](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/884)
