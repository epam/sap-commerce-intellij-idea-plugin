...
- Do not identify `core-customize`, `js-storefront` and `datahub` CCv2 folders as Gradle or Maven modules [#659](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/659)
