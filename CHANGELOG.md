...
### `Other` enhancements
- Do not check for Ultimate plugins when using the Community edition during project import [#1274](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/1274)
