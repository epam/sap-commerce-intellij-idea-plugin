...
- Inject FlexibleSearch language into not concatenated Strings and String Templates without params [#431](https://github.com/epam/sap-commerce-intellij-idea-plugin/pull/431)
