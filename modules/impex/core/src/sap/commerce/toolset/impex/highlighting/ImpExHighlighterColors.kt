...
object ImpExHighlighterColors {
    ...
    val SINGLE_QUOTE_OPEN = key("SINGLE_QUOTE_OPEN", DefaultLanguageHighlighterColors.STRING)
    val SINGLE_QUOTE_CLOSE = key("SINGLE_QUOTE_CLOSE", DefaultLanguageHighlighterColors.STRING)
    val SINGLE_QUOTE_ESCAPE = key("SINGLE_QUOTE_ESCAPE", DefaultLanguageHighlighterColors.VALID_STRING_ESCAPE)
    ...
    val SPECIAL_PARAMETER_MARKER = key("SPECIAL_PARAMETER_MARKER", DefaultLanguageHighlighterColors.INSTANCE_FIELD)
    val SPECIAL_PARAMETER_VALUE = key("SPECIAL_PARAMETER_VALUE", DefaultLanguageHighlighterColors.INSTANCE_FIELD)
