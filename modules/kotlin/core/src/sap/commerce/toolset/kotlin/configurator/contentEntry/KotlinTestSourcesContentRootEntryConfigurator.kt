...
class KotlinTestSourcesContentRootEntryConfigurator : ModuleContentRootEntryConfigurator {
    ...
    override suspend fun configure(
        ...
        val rootEntities = buildList {
            moduleRootPath.resolve(ProjectConstants.Directory.KOTLIN_TEST_SRC)
                .let { moduleEntity.testSources(path = it) }
                .let { add(it) }
        }
