...
object ProjectUtil {
    ...
    private val SKIP_DIRS = setOf(
        ...
        ProjectConstants.Directories.CLASSES,
        ProjectConstants.Directories.TEMP,
        ProjectConstants.Directories.LOG,
        ProjectConstants.Directories.DATA,
        ProjectConstants.Directories.RESOURCES,
        ProjectConstants.Directories.IDEA,
        ProjectConstants.Directories.SRC,
        ProjectConstants.Directories.GROOVY_SRC,
        ProjectConstants.Directories.KOTLIN_SRC,
        ProjectConstants.Directories.TEST_SRC,
        ProjectConstants.Directories.GROOVY_TEST_SRC,
        ProjectConstants.Directories.KOTLIN_TEST_SRC,
        "installer",
        "build-tools",
        "licenses",
        "js-storefront",
