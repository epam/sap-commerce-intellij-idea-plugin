...
class YHacExtModuleDescriptorProvider : ModuleDescriptorProvider {

    override fun isApplicable(context: ModuleDescriptorProviderContext) = context.moduleRoot.type == ModuleDescriptorType.EXT
        && context.moduleRoot.path.name == EiConstants.Extension.HAC

    override fun create(context: ModuleDescriptorProviderContext): YHacExtModuleDescriptor {
        ...
        return YHacExtModuleDescriptor(context.moduleRootPath, extensionInfo).apply {
