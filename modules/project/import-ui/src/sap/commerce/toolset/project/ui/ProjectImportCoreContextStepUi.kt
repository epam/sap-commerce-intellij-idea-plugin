...
internal fun uiCoreStep(context: ProjectImportCoreContext): DialogPanel {
    ...
    return panel {
        ...
        scrollRow(
            content = contentPane(context, rightGaps),
            preferredSize = Dimension(JBUI.DialogSizes.large().width - 100, JBUI.DialogSizes.large().height - 50)
        )
            .bottomGap(BottomGap.SMALL)
    }
}

private fun contentPane(context: ProjectImportCoreContext, rightGaps: UnscaledGaps) = panel {
