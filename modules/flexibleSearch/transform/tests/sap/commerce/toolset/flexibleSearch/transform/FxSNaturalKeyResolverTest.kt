...
class FxSNaturalKeyResolverTest {
    ...
    private fun resolve(snapshot: FxSNaturalKeyResolver.FxSTypeSnapshot, db: Map<String, FxSNaturalKeyResolver.FxSTypeSnapshot> = emptyMap()): String =
    ...
    fun resolve_typeWithCodeAttr_noIndex_fallsBackToCode() {
        val snapshot = FxSNaturalKeyResolver.FxSTypeSnapshot(
            hasCodeAttr = true,
    ...
    fun resolve_fkUniqueKey_recursesToCode() {
        ...
        val currencySnapshot = FxSNaturalKeyResolver.FxSTypeSnapshot(
            hasCodeAttr = false,
            uniqueIndexKeys = listOf("isocode"),
            attrTypes = mapOf("isocode" to "java.lang.String"),
        )
    ...
    fun resolve_catalogVersion_withUniqueIndex_producesCatalogIdCommaVersion() {
        ...
        val catalogSnapshot = FxSNaturalKeyResolver.FxSTypeSnapshot(
            hasCodeAttr = false,
            uniqueIndexKeys = listOf("id"),
            attrTypes = mapOf("id" to "java.lang.String"),
        )
        val catalogVersionSnapshot = FxSNaturalKeyResolver.FxSTypeSnapshot(
            hasCodeAttr = false,
    ...
    fun resolve_product_uniqueIndexOnCode_returnsCode() {
        val productSnapshot = FxSNaturalKeyResolver.FxSTypeSnapshot(
            hasCodeAttr = true,
    ...
    fun resolve_maxDepthReached_returnsPk() {
        ...
        fun snap(type: String) = FxSNaturalKeyResolver.FxSTypeSnapshot(
            hasCodeAttr = false,
