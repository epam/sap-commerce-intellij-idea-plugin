        ...
        if (psiColumns.isEmpty() || psiColumns.size != headers.size) {
            ...
            return headers.map { header ->
                FxSColumn(
                    ...
                    isPk = header.equals(TSConstants.Attribute.PK, ignoreCase = true),
                )
            }
        }
    ...
    private fun analyzeColumn(headerName: String, psiColumn: FlexibleSearchResultColumn): FxSColumn {
        ...
        if (columnRef != null) {
            ...
            return FxSColumn(
                ...
                isPk = attrName.equals(TSConstants.Attribute.PK, ignoreCase = true),
                tableAlias = alias,
            )
        }
        ...
        return FxSColumn(
            ...
            isPk = headerName.equals(TSConstants.Attribute.PK, ignoreCase = true),
        )
    }
        ...
        constraints.forEachIndexed { idx, constraint ->
            ...
            val fkCol = when {
                col0.selectedTableName?.text == joinAlias
                    && col0.yColumnName?.text.equals(TSConstants.Attribute.PK, ignoreCase = true) -> col1
                col1.selectedTableName?.text == joinAlias
                    && col1.yColumnName?.text.equals(TSConstants.Attribute.PK, ignoreCase = true) -> col0
