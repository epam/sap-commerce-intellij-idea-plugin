...
class CxFetchRemotePropertyStateAction : AnAction() {
    ...
    override fun update(e: AnActionEvent) = e.ifNotFromSearchPopup {
        ...
        val stateInitialized = service.stateInitialized

        e.presentation.isEnabled = service.ready
        e.presentation.text = if (stateInitialized) "Refresh Properties" else "Fetch Properties"
        e.presentation.icon = if (stateInitialized) HybrisIcons.Log.Action.REFRESH else HybrisIcons.Log.Action.FETCH
