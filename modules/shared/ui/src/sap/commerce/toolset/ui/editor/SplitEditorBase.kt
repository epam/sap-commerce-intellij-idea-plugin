...
abstract class SplitEditorBase(
    ...
    open var inEditorParametersView: JComponent?
        get() = horizontalSplitter.secondComponent
        set(view) {
            horizontalSplitter.secondComponent = view
        }

    var virtualParametersDisposable: Disposable? = null

    protected open fun renderInEditorParameters() {}
    ...
    protected fun getText(): String = editor.selectionModel.selectedText
