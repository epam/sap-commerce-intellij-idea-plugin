...
class BSBeanReference(
    ...
    override fun getVariants() = _root_ide_package_.sap.commerce.toolset.beanSystem.codeInsight.completion.BSCompletionService.Companion.getInstance(element.project)
        .getCompletions(_root_ide_package_.sap.commerce.toolset.beanSystem.meta.model.BSMetaType.META_BEAN, _root_ide_package_.sap.commerce.toolset.beanSystem.meta.model.BSMetaType.META_WS_BEAN, _root_ide_package_.sap.commerce.toolset.beanSystem.meta.model.BSMetaType.META_EVENT)
        .toTypedArray()
