...
class TSShowMetaRelationsAction : ToggleAction(i18n("hybris.toolwindow.ts.action.relations.text"), null, HybrisIcons.TypeSystem.Types.RELATION) {

    override fun isSelected(e: AnActionEvent): Boolean = e.tsViewSettings?.showMetaRelations
        ?: false
