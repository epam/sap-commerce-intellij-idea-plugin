...
class TSShowMetaEnumValuesAction : ToggleAction(i18n("hybris.toolwindow.ts.action.enum.values.text"), null, null) {

    override fun isSelected(e: AnActionEvent): Boolean = e.tsViewSettings?.showMetaEnumValues
        ?: false
