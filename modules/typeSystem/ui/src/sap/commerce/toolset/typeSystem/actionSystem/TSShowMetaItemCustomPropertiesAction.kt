...
class TSShowMetaItemCustomPropertiesAction : ToggleAction(i18n("hybris.toolwindow.ts.action.item.custom_properties.text"), null, null) {

    override fun isSelected(e: AnActionEvent): Boolean = e.tsViewSettings?.showMetaItemCustomProperties
        ?: false
