...
class TSShowMetaItemAttributesAction : ToggleAction(i18n("hybris.toolwindow.ts.action.item.attributes.text"), null, null) {

    override fun isSelected(e: AnActionEvent): Boolean = e.tsViewSettings?.showMetaItemAttributes
        ?: false
