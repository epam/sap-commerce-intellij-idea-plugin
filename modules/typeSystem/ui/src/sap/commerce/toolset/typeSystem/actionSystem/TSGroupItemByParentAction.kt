...
class TSGroupItemByParentAction : ToggleAction(i18n("hybris.toolwindow.ts.action.item.group_by_parent.text"), null, null) {

    override fun isSelected(e: AnActionEvent): Boolean = e.tsViewSettings?.groupItemByParent
        ?: false
