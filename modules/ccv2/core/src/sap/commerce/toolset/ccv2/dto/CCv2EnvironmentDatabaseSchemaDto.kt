...
data class CCv2EnvironmentDatabaseSchemaDto(
    val code: String,
    ...
    companion object {
        internal fun map(dto: EnvironmentDatabaseSchemaScalingDetailDTO): CCv2EnvironmentDatabaseSchemaDto? {
            ...
            return CCv2EnvironmentDatabaseSchemaDto(
                code = dto.code,
