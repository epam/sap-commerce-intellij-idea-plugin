...
object HybrisConstants {
	...
	const val CLASS_FQN_INTERCEPTOR_TYPE =
	...
	const val CLASS_FQN_CMS_RESTRICTION_EVALUATOR_MAPPING =
	...
	const val CLASS_FQN_CONFIG_IMPORT_PROCESSOR =
	...
	const val CLASS_FQN_CNG_COLLECTION_BROWSER_MOLD_STRATEGY =
		"com.hybris.cockpitng.widgets.collectionbrowser.mold.CollectionBrowserMoldStrategy"
	...
	const val URL_HELP_JAVADOC_FALLBACK =
		"https://help.sap.com/docs/SAP_COMMERCE/c5613bd3cc9942efb74d017b40eb0892/179bbc9b35274d7ca784e46b3beb40b2.html"
	const val URL_HELP_JAVADOC = "https://help.sap.com/doc/9fef7037b3304324b8891e84f19f2bf3/%s/en-US"
	const val URL_HELP_GENERATING_API_TOKENS =
		"https://help.sap.com/docs/SAP_COMMERCE_CLOUD_PUBLIC_CLOUD/0fa6bcf4736c46f78c248512391eb467/b5d4d851cbd54469906a089bb8dd58d8.html"
	...
	@JvmField
	val ALL_SRC_DIR_NAMES =
		listOf(GEN_SRC_DIRECTORY, SRC_DIRECTORY, GROOVY_SRC_DIRECTORY, KOTLIN_SRC_DIRECTORY, SCALA_SRC_DIRECTORY)

	@JvmField
	val TEST_SRC_DIR_NAMES =
		listOf(TEST_SRC_DIRECTORY, GROOVY_TEST_SRC_DIRECTORY, KOTLIN_TEST_SRC_DIRECTORY, SCALA_TEST_SRC_DIRECTORY)
	...
	@JvmStatic
	val KEY_FINALIZE_PROJECT_IMPORT: Key<Triple<HybrisProjectDescriptor, List<ModuleDescriptor>, Boolean>> =
		Key.create("hybrisProjectImportFinalize")
