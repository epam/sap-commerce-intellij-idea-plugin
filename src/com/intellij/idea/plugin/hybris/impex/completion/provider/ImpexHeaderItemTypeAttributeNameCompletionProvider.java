...
public class ImpexHeaderItemTypeAttributeNameCompletionProvider extends CompletionProvider<CompletionParameters> {
    ...
    protected void fillDomAttributesCompletions(
        ...
        final Optional<TSGlobalMetaItem> metaItem = Optional.ofNullable(metaService.findMetaItemByName(itemTypeCode));
        ...
        metaItem
            .map(meta -> TSMetaItemService.getInstance(project).getReferenceEnds(meta, true).stream())
            .orElse(Stream.empty())
