...
public class AclUserRightsValueUidImpl extends ASTWrapperPsiElement implements AclUserRightsValueUid {

  public AclUserRightsValueUidImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AclVisitor visitor) {
    visitor.visitUserRightsValueUid(this);
  }
