...
public class AclUserRightsValuePasswordImpl extends ASTWrapperPsiElement implements AclUserRightsValuePassword {

  public AclUserRightsValuePasswordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull AclVisitor visitor) {
    visitor.visitUserRightsValuePassword(this);
  }
