...
public class AclUserRightsHeaderLineImpl extends ASTWrapperPsiElement implements AclUserRightsHeaderLine {
  ...
  @Override
  @NotNull
  public List<AclUserRightsHeaderParameter> getUserRightsHeaderParameterList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, AclUserRightsHeaderParameter.class);
  }
